    ...
    <div className="min-h-[calc(100vh-116px)] flex flex-col justify-between items-center">
      ...
      <div className="w-full sticky bottom-0 p-4 flex justify-between items-center shadow-lg">
        <button
          ...
          className={`bg-[#FFFFFF] text-black font-[700] rounded-[16px] px-3 py-2 text-[18px] border border-[#000] transition duration-300 ease-in-out focus:outline-none focus:ring-0 focus:ring-[#464646] focus:shadow-[0_0_12px_#92ae1f] ${
            viewState === 'search' ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-[#c1f001]'
          }`}
        >
          Previous
        </button>
